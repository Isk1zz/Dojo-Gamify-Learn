...
(() => {
  ...
  const THEMES = I18N.resolve([
    { id: "indigo", name: { en: "Indigo Night", ru: "Индиговая ночь" }, swatch: "#6366f1",
  ...
  const PREMIUM_THEMES = I18N.resolve([
    {
      id: "sakura", name: { en: "Sakura Midnight", ru: "Сакура в полночь" }, price: 90, tagline: "Petals over a plum-dark sky",
    ...
    },
    {
      ...
      id: "paper", name: { en: "Paper", ru: "Бумага" }, price: 80, tagline: "A warm, sunlit page", mode: "light",
    ...
    {
      id: "sumi", name: { en: "Sumi Ink", ru: "Тушь суми" }, price: 110, tagline: "Brush and paper, nothing else",
    ...
    {
      id: "terminal", name: { en: "Amber Terminal", ru: "Янтарный терминал" }, price: 120, tagline: "CRT glow, 1979",
    ...
    {
      id: "koi", name: { en: "Koi Pond", ru: "Пруд с карпами" }, price: 150, tagline: "Orange fish, deep green water",
    ...
    {
      id: "ronin", name: { en: "Neon Ronin", ru: "Неоновый ронин" }, price: 180, tagline: "Rain, signage, no sleep",
    ...
    {
      id: "fuji", name: { en: "Fuji Dawn", ru: "Рассвет над Фудзи" }, price: 220, tagline: "First light on the mountain",
    ...
    },
    {
      ...
      id: "kirigami", name: { en: "Kirigami", ru: "Киригами" }, price: 260, tagline: "Paper torn to the panel beneath",
  ...
  const BG_STRIPES = I18N.resolve([
    {
      id: "diagonal", name: { en: "Diagonal", ru: "Диагональ" },
      css: "repeating-linear-gradient(120deg, rgba(255,255,255,0.035) 0 2px, transparent 2px 40px)"
    },
    {
      id: "crosshatch", name: { en: "Cross-hatch", ru: "Штриховка" },
    ...
    {
      id: "herringbone", name: { en: "Herringbone", ru: "Ёлочка" },
    ...
    },
    {
      ...
      id: "lattice", name: { en: "Lattice", ru: "Решётка" },
    ...
    },
    {
      ...
      id: "trellis", name: { en: "Trellis", ru: "Шпалера" },
    ...
    },
    {
      ...
      id: "origami", name: { en: "Origami", ru: "Оригами" },
    ...
    },
    {
      ...
      id: "sunburst", name: { en: "Sunburst", ru: "Солнечные лучи" },
