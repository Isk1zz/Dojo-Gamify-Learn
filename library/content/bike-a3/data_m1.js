      ...
      chunks: [
        {
          ...
          explain: {
            blocks: [
              ...
              { heading: { ru: "Почему именно справа", en: "Why the right specifically" }, text: { ru: `Движение в стране правостороннее, и медленный участник держится ближе к краю, чтобы быстрые обгоняли его слева — со стороны, куда водитель смотрит и где у него зеркало.<br><br>Поехав слева, вы встречаетесь с машинами лоб в лоб: скорости складываются, и времени на реакцию не остаётся ни у кого. Логика «как пешеход» здесь ломается — пешеход идёт 5 км/ч и может шагнуть в сторону, вы едете 25 и не можете.<br><br>И два правила, которые всё это перебивают. Если вдоль дороги идёт <strong>велодорожка, обозначенная знаком</strong>, ехать по любой другой части дороги <em>запрещено</em> — не «желательно», а нельзя. А тому, кому <strong>ещё нет 12</strong>, на загородной дороге ездить нельзя вовсе.`, en: `Traffic here drives on the right, and the slow participant keeps to the edge so that faster ones overtake on the left — the side the driver is facing and where the mirror is.<br><br>Ride on the left and you meet cars head-on: the speeds add together and nobody has any time to react. The "just like a pedestrian" logic breaks here — a pedestrian walks at 5 km/h and can step aside, you are doing 25 and cannot.<br><br>Two rules override all of that. Where a <strong>signed cycle path</strong> runs along the road, riding on any other part of it is <em>forbidden</em> — not discouraged, forbidden. And anyone <strong>under 12</strong> may not ride on a non-urban road at all.` } }
            ],
            ...
            sources: [
              { ref: { ru: `<bdi>תקנות התעבורה, התשכ״א-1961, תקנות 128 ו-129(ב), (ה), (ו)</bdi>. Полный текст: nevo.co.il/law_html/law01/p230_011.htm`, en: `Israeli Traffic Regulations 1961, regs. 128 and 129(b), (e), (f) — <bdi>תקנות התעבורה, התשכ״א-1961</bdi>. Full text: nevo.co.il/law_html/law01/p230_011.htm` }, note: { ru: `128 — держаться правой стороны. 129(ב) — при обозначенной велодорожке ехать по остальной дороге нельзя. 129(ה) — обязанность ехать по чистой асфальтированной обочине за городом. 129(ו) — до 12 лет загородные дороги запрещены.`, en: `128 — keep right. 129(b) — where a cycle path is signed, riding elsewhere on the road is prohibited. 129(e) — the duty to use a clear asphalt shoulder out of town. 129(f) — under-12s are barred from non-urban roads.` } },
          ...
          example: {
            ...
            steps: [
              ...
              { ru: `Улица с велодорожкой, обозначенной знаком — <strong>только на велодорожку</strong>. Это не предпочтение: по остальной дороге в этом случае ехать запрещено.`, en: `A street with a signed cycle path — <strong>the cycle path, and nothing else</strong>. Not a preference: riding on the rest of the road is forbidden where one exists.` }
            ]
          },
          quiz: {
          ...
          recall: {
            ...
            points: [
              { ru: `Есть велодорожка со знаком — только по ней, остальное запрещено`, en: `A signed cycle path — use it, the rest of the road is forbidden` },
              ...
              { ru: `Слева нельзя — встречный поток. Кому нет 12 — нельзя за городом`, en: `Never ride on the left. Under 12: no non-urban roads at all` }
            ]
          },
...

        {
          ...
          explain: {
            blocks: [
              { text: { ru: `Пересекать <em>обычный</em> пешеходный переход верхом на велосипеде нельзя. Слезьте и перекатите велосипед рядом — тогда вы пешеход и переход ваш.<br><br>Но есть и второй законный способ, о котором молчит экзамен: существует отдельный <strong>переход для велосипедистов</strong>, обозначенный тамруром <bdi>812</bdi>. По нему разрешено ехать верхом — осторожно и убедившись, что дорога свободна.<br><br>Разница не формальная. Переход — единственное место, где водитель обязан пропустить человека, и весь его расчёт построен на скорости пешехода.`, en: `You may not ride across an <em>ordinary</em> pedestrian crossing. Dismount and walk the bicycle over — at that point you are a pedestrian and the crossing is yours.<br><br>But there is a second lawful way, and the exam is silent about it: a dedicated <strong>cyclist crossing</strong> marked with sign <bdi>812</bdi>, which you may ride across — carefully, and having checked the road is clear.<br><br>The difference is not a formality. The crossing is the one place where a driver is obliged to stop for a person, and his entire judgement is built around pedestrian speed.` } },
            ...
            sources: [
              ...
              { ref: { ru: `<bdi>תקנות התעבורה, התשכ״א-1961, תקנה 129(ז)</bdi>. Полный текст: nevo.co.il/law_html/law01/p230_011.htm`, en: `Israeli Traffic Regulations 1961, reg. 129(g) — <bdi>תקנות התעבורה, התשכ״א-1961</bdi>. Full text: nevo.co.il/law_html/law01/p230_011.htm` }, note: { ru: `Дословно: «לא יעבור רוכב אופניים במעבר חציה ברכיבה אלא במעבר חציה לרוכבי אופניים המסומן בתמרור 812» — верхом нельзя, КРОМЕ перехода для велосипедистов с тамруром 812. Экзаменационный вопрос 0005 про обычный переход, поэтому исключение в него не попало.`, en: `Verbatim: "לא יעבור רוכב אופניים במעבר חציה ברכיבה אלא במעבר חציה לרוכבי אופניים המסומן בתמרור 812" — no riding across, EXCEPT a cyclist crossing marked with sign 812. Exam question 0005 asks about an ordinary crossing, which is why the exception never appears in it.` } }
            ]
          },
          example: {
            ...
            steps: [
              ...
              { ru: `Переход пуст, вы проехали верхом и никого не задели — <strong>нарушение всё равно</strong>, если это обычный переход: запрет не зависит от того, чем всё закончилось. На переходе с тамруром 812 — не нарушение.`, en: `The crossing was empty, you rode over it and hit nobody — <strong>an offence all the same</strong>, if it was an ordinary crossing: the ban does not depend on how it turned out. At a sign-812 crossing it is no offence.` }
            ]
          },
          quiz: {
            ...
            correct: 0,
            explanation: { ru: `Закон различает не скорость, а положение: сидите на велосипеде — вы транспортное средство, и обычный переход не для вас; ведёте его рядом — вы пешеход. (Отдельный переход для велосипедистов, тамрур 812, — исключение, но в вопросе речь о обычном.) Второй вариант соблазнителен, потому что кажется безопасным по сути, но водитель принимает решение по одному признаку: появился человек или нет. Велосипед под вами меняет и скорость появления, и то, откуда вы появитесь.`, en: `The law distinguishes posture, not speed: sitting on the bicycle you are a vehicle and an ordinary crossing is not for you; walking it beside you, you are a pedestrian. (A dedicated cyclist crossing, sign 812, is the exception — but the question is about an ordinary one.) The second option tempts because it feels safe in substance, but the driver decides on one signal — has a person appeared or not. The bicycle under you changes both how fast you appear and where you appear from.` }
          },
          recall: {
            ...
            answer: { ru: `Пересекать верхом ОБЫЧНЫЙ переход запрещено — нужно слезть и перекатить велосипед, и в этот момент вы пешеход. Исключение одно: переход для велосипедистов с тамруром 812, по нему можно ехать верхом. Одновременно действует встречная обязанность: когда пешеход переходит дорогу по переходу, велосипедист обязан уступить ему дорогу, безусловно, без оговорок про права и возраст. Причина в расчёте водителя: он готов остановиться перед человеком, идущим 5 км/ч, а не перед транспортом, выезжающим на переход со скоростью 25 км/ч.`, en: `Riding across an ORDINARY crossing is forbidden — dismount and walk the bicycle over, and at that moment you are a pedestrian. There is one exception: a cyclist crossing marked with sign 812, which may be ridden across. A matching duty runs the other way: when a pedestrian is crossing at a crossing, the rider must give way, unconditionally, with no qualifier about licence or age. The reason lies in the driver's judgement: he is ready to stop for a person walking at 5 km/h, not for a vehicle entering the crossing at 25.` },
            points: [
              { ru: `Верхом через обычный переход нельзя`, en: `You may not ride across an ordinary crossing` },
              { ru: `Слезть и перекатить — можно; тамрур 812 — можно верхом`, en: `Dismount and walk — or ride, at a sign-812 crossing` },
