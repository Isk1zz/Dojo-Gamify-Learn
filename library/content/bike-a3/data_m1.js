      ...
      chunks: [
        {
          ...
          glossary: [
            ...
            { term: "SI 15194", definition: { ru: "Израильский стандарт на электровелосипеды: мотор до 250 Вт, привод от педалей, отключение выше 25 км/ч.", en: "The Israeli standard for electric bicycles: motor up to 250 W, driven from the pedals, cut-off above 25 km/h." } },
          ...
          explain: {
            blocks: [
              ...
              { heading: { ru: "Четыре условия стандарта", en: "The standard's four conditions" }, text: { ru: `Чтобы электровелосипед считался стандартным, он должен отвечать израильскому стандарту <strong>SI 15194</strong>: мощность двигателя не выше 250 Вт; двигатель работает от вращения педалей, а не от ручки газа; его помощь слабеет по мере разгона; и он полностью отключается, когда скорость превышает <strong>25 км/ч</strong>.<br><br>Условия работают вместе, а не по отдельности. Сняли ограничитель, поставили мотор помощнее, добавили курок газа — нарушено одно условие, а значит нарушен весь стандарт.`, en: `To count as standard, an electric bicycle must meet the Israeli standard <strong>SI 15194</strong>: motor output no higher than 250 W; the motor driven by turning the pedals rather than by a throttle; its assistance falling away as speed rises; and it must cut out entirely once speed passes <strong>25 km/h</strong>.<br><br>The four work together, not separately. Remove the limiter, fit a stronger motor, add a throttle — break one condition and you have broken the whole standard.` } },
          ...
          recall: {
            ...
            points: [
              ...
              { ru: `Привод от педалей, а не от ручки газа`, en: `Driven from the pedals, not from a throttle` },
    ...
    // ============================================================
    {
      ...
      chunks: [
...

        {
          ...
          explain: {
            blocks: [
              { text: { ru: `Везти второго человека на электровелосипеде можно только в одном случае: если аппарат <em>специально для этого предназначен</em> — то есть конструкцией предусмотрено место для ещё одного человека.<br><br>Не «если пассажиру есть 16», не «если оба в шлемах», не «если недалеко». Условие ровно одно, и оно про велосипед, а не про людей на нём.`, en: `You may carry a second person on an electric bicycle in one case only: if the machine is <em>purpose-built for it</em> — that is, a place for another person is part of its design.<br><br>Not "if the passenger is 16", not "if both wear helmets", not "if it is a short way". There is exactly one condition, and it is about the bicycle rather than about the people on it.` } },
            ...
            sources: [
              { ref: { ru: `<bdi>תקנות התעבורה, התשכ״א-1961, תקנה 124 — «הרכבת אנשים על אופניים»</bdi>. Полный текст: nevo.co.il/law_html/law01/p230_011.htm`, en: `Israeli Traffic Regulations 1961, reg. 124 — <bdi>תקנות התעבורה, התשכ״א-1961, תקנה 124 — «הרכבת אנשים על אופניים»</bdi>. Full text: nevo.co.il/law_html/law01/p230_011.htm` }, note: { ru: `Норма о перевозке людей на велосипеде: требование к конструкции и отдельное сиденье для ребёнка.`, en: `The regulation on carrying people on a bicycle: the design requirement and the separate seat for a child.` } },
          ...
          recall: {
            prompt: { ru: "При каких условиях на электровелосипеде можно везти второго человека — взрослого и ребёнка до 8 лет?", en: "Under what conditions may you carry a second person on an electric bicycle — an adult, and a child under 8?" },
            answer: { ru: `Взрослого пассажира можно везти только на велосипеде, конструкция которого специально предусматривает второго человека. Ни шлемы, ни возраст пассажира, ни короткая дистанция условием не являются. Ребёнка младше 8 лет можно везти при двух условиях одновременно: на велосипеде установлено отдельное сиденье, обеспечивающее его безопасность, и на ребёнке подходящий шлем. Багажник или рама сиденьем не считаются.`, en: `An adult passenger may be carried only on a bicycle whose design specifically provides for a second person. Neither helmets, nor the passenger's age, nor a short distance is a condition. A child under 8 may be carried on two conditions at once: a separate seat securing the child is fitted, and the child wears a suitable helmet. A rack or the frame does not count as a seat.` },
            points: [
              { ru: `Взрослый — только если велосипед предназначен для двоих`, en: `An adult — only if the bicycle is built for two` },
              { ru: `Шлемы и короткая поездка условием не являются`, en: `Helmets and a short trip are not conditions` },
              { ru: `Ребёнок до 8 лет — отдельное сиденье`, en: `A child under 8 — a separate seat` },
              { ru: `Ребёнок до 8 лет — и подходящий шлем`, en: `A child under 8 — and a suitable helmet` }
            ]
          },
      ...
      chunks: [
        {
          ...
          recall: {
            ...
            points: [
              ...
              { ru: `Эффективный тормоз`, en: `An efficient brake` },
              { ru: `Задний отражатель`, en: `A rear reflector` },
              { ru: `В темноте: белая фара на 150 метров, красный фонарь сзади, жёлтые отражатели на педалях`, en: `After dark: white lamp to 150 m, red rear light, yellow pedal reflectors` }
            ]
          },
