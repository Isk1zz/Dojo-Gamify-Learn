    ...
    // ============================================================
    {
      ...
      chunks: [
...

        {
          ...
          explain: {
            blocks: [
              ...
              { heading: { ru: "Написано против конкретного человека", en: "Written against a specific man" }, text: { ru: `Книга не абстрактна. Он прямо обвиняет Цезаря в <strong>temeritas</strong> — безрассудстве, попиравшем «все законы божеские и человеческие» ради власти, которую тот вообразил себе. Цезарь для него — доказательство от противного: ум без доброты, обращённый в тиранию.<br><br>А во второй книге есть строка, звучащая почти как предупреждение самому себе на будущий год: <em>«острее укус вновь обретённой свободы, чем свободы, никогда не терявшейся»</em>.`, en: `The book is not abstract. He accuses Caesar directly of <strong>temeritas</strong> — recklessness that trampled "all laws of gods and men" for a supremacy Caesar had imagined for himself. Caesar functions as proof by contradiction: intelligence without goodness, turned into tyranny.<br><br>And a line in Book Two reads almost like a warning to himself for the year ahead: <em>"the fangs of a liberty regained are sharper than those of a liberty never repressed."</em>` } }
            ],
...

        {
          ...
          glossary: [
            { term: { ru: "Tusculanae Disputationes", en: "Tusculan Disputations" }, definition: { ru: "Диалоги 45 года — того же, что и смерть Туллии. Действие отнесено к его вилле в Тускуле, отсюда и название. Меньше техники, больше прямого убеждения читателя и себя самого.", en: "Dialogues of 45 BC — the year of Tullia's death. The dialogue is set at his villa at Tusculum, hence the title. Less technical than his other works, more a direct attempt to persuade the reader, and himself." } },
          ...
          explain: {
            blocks: [
              { text: { ru: `«Тускуланские беседы» написаны в 45 году — в тот же год, что и смерть Туллии из темы 1; действие их отнесено к его вилле в Тускуле, откуда и название. Книга менее техническая, чем его другие философские труды: меньше разбора школ, больше прямого убеждения — не только читателя, но, как замечают исследователи, и самого автора.<br><br>Первая книга целиком посвящена одному вопросу: как перестать бояться смерти.`, en: `The *Tusculan Disputations* were written in 45 BC — the same year as Tullia's death in Topic 1; the dialogue is set at his villa at Tusculum, which is where the title comes from. The book is less technical than his other philosophical works: less comparison of schools, more direct persuasion — not only of the reader but, as scholars have noted, of the author himself.<br><br>The first book is devoted entirely to one question: how to stop fearing death.` } },
              ...
              { heading: { ru: "Слова, которые он потом исполнил", en: "The words he later kept" }, text: { ru: `Года через два с половиной, на дороге у Кайеты, — тема 1: он высунулся из носилок и подставил шею, не дрогнув. Ливий пишет об этом почти без пафоса, как о факте.<br><br>Между «Тускуланскими беседами» и той дорогой лежит почти всё, что описано в темах 1 и 2: убийство Цезаря, последняя схватка с Антонием, проскрипции. Он писал о том, как не бояться смерти, за два с лишним года до того, как ему пришлось это на самом деле не бояться — и, судя по единственному дошедшему рассказу, у него получилось.`, en: `Some two and a half years later, on the road near Caieta — Topic 1: he leaned out of the litter and offered his neck without flinching. Livy records it almost without pathos, as a plain fact.<br><br>Between the *Tusculan Disputations* and that road lies nearly everything Topics 1 and 2 describe: Caesar's assassination, the last fight with Antony, the proscriptions. He wrote about not fearing death more than two years before he actually had to not fear it — and, on the one account that survives, he did.` } }
            ],
          ...
          example: {
            ...
            steps: [
              { ru: `45 год: он пишет, что вся жизнь философа — подготовка к смерти.`, en: `45 BC: he writes that a philosopher's whole life is a rehearsal for death.` },
              ...
              { ru: `Проходит больше двух лет — гибель республики, проскрипции.`, en: `More than two years pass — the Republic's collapse, the proscriptions.` },
